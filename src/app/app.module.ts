...
import { AdvancedMapComponentService } from './services/ui/advanced-map-component.service';
...
@NgModule({
    ...
    providers: [AuscopeApiService, RectanglesEditorService, AdvancedMapComponentService, NVCLService, GraceService],
    imports: [
